...
![Project Hero](docs/assets/dashboard-overview.webp)
...
![Security Audit Trace](docs/assets/security-audit-flow.webp)
...
Efficiently manage autonomous agents with budget edit safety and "Nuclear Option" revocation.

![Governance Demo](docs/assets/governance-demo.webp)

### Real-time Registry
Maintain a sovereign source of truth for all agentic budgets.

![Agent Management Registry](docs/assets/agent-management.png)
